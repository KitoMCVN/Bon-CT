...
const Members: React.FC = () => {
  ...
  return (
    <div className="grid lg:grid-cols-3 grid-cols-1 items-start w-full gap-y-5 lg:gap-x-5">
      <div className="col-span-1 flex lg:flex-col flex-col sm:flex-row gap-4">
      ...
      <div className="rounded-lg col-span-2 w-full shadow-[0_0_10px_rgba(0,0,0,0.25)] bg-white dark:bg-slate-800">
        <div className="flex p-[15px] pr-14 border-b-[2px] border-b-sky-600">
          <h3 className="font-extrabold text-sm uppercase text-gray-800 dark:text-gray-50">Discord Online</h3>
        </div>
        <div className="px-[15px] sm:grid grid-cols-2 gap-x-4">
